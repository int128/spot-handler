...
// SpotInterruptedPodSpec defines the desired state of SpotInterruptedPod
type SpotInterruptedPodSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of SpotInterruptedPod. Edit spotinterruptedpod_types.go to remove/update
