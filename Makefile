...
.PHONY: generate
generate: generate-controller generate-mocks
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name spot-handler-builder
	$(CONTAINER_TOOL) buildx use spot-handler-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm spot-handler-builder
	rm Dockerfile.cross
